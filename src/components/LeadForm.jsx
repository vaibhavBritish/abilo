...
import { Phone, EnvelopeSimple, User, ArrowRight, CheckCircle, CircleNotch, Truck } from "@phosphor-icons/react";
        ...
        >
          ...
          <div className="text-center md:text-left flex flex-col items-center md:items-start">
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "0.65rem", marginTop: "2rem" }}>
              {["⭐ 4.9/5 Rating", "🛡️ Fully Insured", "✅ 5K+ Moves", "🔒 Secure Bookings"].map((b) => (
              ...
              <>
                ...
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                  ...
                  <div>
                    ...
                    <div style={inputWrap}>
                      <Truck size={16} style={inputIcon} />
                      <select
                        name="service"
                        value={form.service}
                        onChange={handleChange}
                        style={{ ...inputStyle, paddingLeft: "2.5rem", appearance: "none", background: "#001219", borderColor: "rgba(255,255,255,0.1)" }}
