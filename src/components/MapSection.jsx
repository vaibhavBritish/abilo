    ...
    >
      <div className="container-custom">
        ...
        <div style={{ textAlign: "center", marginBottom: "1.5rem" }}>
          <div className="section-badge" style={{ background: "rgba(255, 90, 0, 0.1)", color: "#ff5a00", border: "1px solid rgba(255, 90, 0, 0.2)", justifyContent: "center" }}>📍 Find Us</div>
          <h2 className="section-title">Our Location in Toronto</h2>
