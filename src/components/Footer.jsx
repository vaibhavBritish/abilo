...
export const Footer = () => {
  ...
  const services = [
    "Residential Moving", "Office Relocation", "Commercial Moving",
    "Packing Services", "Storage Solutions", "Long Distance Moving",
  ];
        ...
        >
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            ...
            <p style={{ fontSize: "0.85rem", lineHeight: 1.7, color: "var(--text-muted)", marginBottom: "1.25rem" }}>
              Canada's premier moving and storage company. 
              Providing reliable, professional relocation services across the nation.
            </p>
          ...
          <div>
            ...
            <a href="tel:+1800555ABIL" style={{ display: "flex", alignItems: "flex-start", gap: 10, textDecoration: "none", marginBottom: "1rem" }}>
              <Phone size={16} weight="fill" style={{ color: "#ff5a00", marginTop: 2 }} />
              <div>
                <div style={{ color: "#E5E7EB", fontSize: "0.85rem" }}>+1-800-555-ABIL</div>
              </div>
            </a>
            <a href="mailto:contact@abilo.ca" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none", marginBottom: "1rem" }}>
              <EnvelopeSimple size={16} weight="fill" style={{ color: "#ff5a00" }} />
              <div style={{ color: "#E5E7EB", fontSize: "0.85rem" }}>contact@abilo.ca</div>
            </a>
            <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
              ...
              <div style={{ color: "#E5E7EB", fontSize: "0.82rem", lineHeight: 1.6 }}>
                123 Maple Street <br />Toronto, Ontario, Canada
              </div>
            </div>
      ...
      <div style={{ padding: "1.25rem 0" }}>
        <div className="container-custom" style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "0.75rem" }}>
          <p style={{ fontSize: "0.8rem", color: "var(--text-muted)", margin: 0 }}>
            © 2026 Abilo Moving and Storage. All rights reserved.
          </p>
