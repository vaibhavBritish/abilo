        ...
        <div className="container-custom">
          <div className="text-center mb-12 max-w-3xl mx-auto">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              we've handled across Western Canada.
            </p>
          </div>
          ...
          >
            ...
            {[
              ...
              <div key={idx} style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                <div style={{ fontSize: "1.75rem", marginBottom: 8, color: "var(--secondary)" }}>{icon}</div>
                <div style={{ fontFamily: "Poppins, sans-serif", fontWeight: 800, fontSize: "1.5rem", color: "var(--secondary)" }}>{value}</div>
